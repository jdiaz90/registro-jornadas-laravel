...
// Ruta para cambiar a localización
Route::get('/locale/{locale}', [LocaleController::class, 'change'])->name('locale.change');

// Rutas que requieren autenticación e que aplican o middleware "locale"
Route::middleware(['auth', 'locale'])->group(function () {

    // Dashboard do usuario
    Route::get('/dashboard', [DashboardController::class, 'index'])->name('dashboard');

    // Perfil: accións propias do usuario
    ...
    // Rutas para Work Logs e Calendario
    ...
    // Rutas para verificar a autenticidade dun WorkLog
    ...
    // Rutas para iniciar e finalizar pausas
    ...
    // Rutas de administración (só para administradores)
    Route::middleware(['admin'])->prefix('admin')->name('admin.')->group(function () {
        // Dashboard administrativo
        Route::get('/dashboard', [AdminDashboardController::class, 'index'])->name('dashboard');

        // Nova ruta para listar todos os rexistros (de máis recente a máis novo)
        Route::get('/work-logs', [WorkLogController::class, 'adminIndex'])->name('work_logs.index');

        // Rutas para a administración de usuarios
        ...
        // Rutas de administración para Work Logs (edición e actualización)
