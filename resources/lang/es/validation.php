...
return [
    ...
    | predeterminados utilizados por la clase de validación.
    | Algunas reglas tienen múltiples versiones (como las reglas de tamaño).
    | Siéntete libre de modificar cada uno de estos mensajes.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes definir nombres amigables para los atributos.
    | Por ejemplo, en lugar de mostrar "check_in" en el mensaje de error,
    | se mostrará "hora de entrada".
    |
    */
    ...
    'attributes' => [
        ...
        'modification_reason' => 'Motivo de modificación',
    ],
