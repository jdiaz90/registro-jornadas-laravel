<x-app-layout>
    ...
    <div class="py-6" data-contract-type="{{ $workLog->user->contract_type }}">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <!-- Formulario de edición (se agrupan los campos como antes) -->
            <!-- ... (tu formulario con las agrupaciones ya implementadas) ... -->
            <form id="work_log_form" action="{{ route('admin.work_logs.update', $workLog->id) }}" method="POST">
                ...
                <div class="mb-6 p-4 border border-gray-200 rounded">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Check In -->
                        <div>
                            <label for="check_in" class="block text-gray-700 font-bold">{{ __('work_logs.edit.check_in_label') }}</label>
                        ...
                        <!-- Check Out -->
                        <div>
                            <label for="check_out" class="block text-gray-700 font-bold">{{ __('work_logs.edit.check_out_label') }}</label>
                        ...
                        <!-- Inicio de Pausa -->
                        <div>
                            <label for="pause_start" class="block text-gray-700 font-bold">{{ __('work_logs.edit.pause_start_label') }}</label>
                        ...
                        <!-- Fin de Pausa -->
                        <div>
                            <label for="pause_end" class="block text-gray-700 font-bold">{{ __('work_logs.edit.pause_end_label') }}</label>
                ...
                <div class="mb-6 p-4 border border-gray-200 rounded">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Horas Ordinarias -->
                        <div>
                            <label for="ordinary_hours" class="block text-gray-700 font-bold">{{ __('work_logs.edit.ordinary_hours_label') }}</label>
                        ...
                        <div>
                            <label for="complementary_hours" class="block text-gray-700 font-bold">{{ __('work_logs.edit.complementary_hours_label') }}</label>
                        ...
                        <div>
                            <label for="overtime_hours" class="block text-gray-700 font-bold">{{ __('work_logs.edit.overtime_hours_label') }}</label>
                        ...
                        <!-- Minutos de Pausa -->
                        <div>
                            <label for="pause_minutes" class="block text-gray-700 font-bold">{{ __('work_logs.edit.pause_minutes_label') }}</label>
                ...
                <div class="mb-4">
                    <label for="hash" class="block text-gray-700 font-bold">{{ __('work_logs.edit.current_hash_label') }}</label>
                ...
                <div class="mb-4">
                    <label for="modification_reason" class="block text-gray-700 font-bold">{{ __('work_logs.edit.modification_reason_label', ['id' => $workLog->id]) }}</label>
